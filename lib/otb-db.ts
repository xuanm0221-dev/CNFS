...
const MLB_OTB_HARDCODE: Record<OtbSeason, number> = {
  '27F': 0, // 고정
  '27S': 328_479_000, // 고정 328,479K (2026-09-08 갱신, 이전 307,262K)
  '26F': 2_705_402_000, // 목표 (Snowflake 실제가 이걸 넘으면 실제 사용)
  '26S': 2_316_846_000, // 목표
  '25F': 50_000_000, // 목표 (5,000만위안, 2026-09-08 갱신 — 이전 84,000K)
};
...
const DISCOVERY_OTB_HARDCODE: Record<OtbSeason, number> = {
  '27F': 0, // 고정
  '27S': 0, // 고정 0 (2026-09-08 갱신, 이전 43,570K) — 26년 내 출고분 없음
  '26F': 135_258_137,
  '26S': 76_186_913,
  '25F': 0,
};
