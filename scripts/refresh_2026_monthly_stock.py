...
public/data/inventory/2026/monthly-stock-{brand}.json 저장

사용법:
  python scripts/refresh_2026_monthly_stock.py --baseMonth 2           # 1~2월 실적 전처리
  python scripts/refresh_2026_monthly_stock.py --baseMonth 3           # 1~3월 실적 전처리
  python scripts/refresh_2026_monthly_stock.py --baseMonth 2 --brand MLB  # MLB만
...
def main():
    parser = argparse.ArgumentParser(description="2026년 월별재고 전처리")
    parser.add_argument(
        "--baseMonth",
        type=int,
        required=True,
    ...
    print("=" * 55)
    print(f"  2026년 월별재고 전처리  (실적: 1~{args.baseMonth}월)")
