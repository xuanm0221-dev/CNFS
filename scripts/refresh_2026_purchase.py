...
public/data/inventory/2026/purchase-{brand}.json 저장

사용법:
  python scripts/refresh_2026_purchase.py --baseMonth 2          # 1~2월 실적
  python scripts/refresh_2026_purchase.py --baseMonth 3          # 1~3월 실적
  python scripts/refresh_2026_purchase.py --baseMonth 2 --brand MLB  # MLB만
...
def main():
    parser = argparse.ArgumentParser(description="2026년 매입상품 전처리")
    parser.add_argument(
        "--baseMonth",
        type=int,
        required=True,
    ...
    print("=" * 55)
    print(f"  2026년 매입상품 전처리  (실적: 1~{args.baseMonth}월)")
